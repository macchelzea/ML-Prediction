...
from PredictiveAnalytics.constants import APP_HOST, APP_PORT
from PredictiveAnalytics.pipline.prediction_pipeline import TravelData, TravelClassifier
...
async def index(request: Request):
    ...
    return templates.TemplateResponse(
            "travel.html",{"request": request, "context": "Rendering"})
